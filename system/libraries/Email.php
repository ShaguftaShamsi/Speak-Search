...
class CI_Email {
	...
	var	$smtp_host		= "mail.finaltier.com";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "shagufta.shamsi@finaltier.com";		// SMTP Username
	var	$smtp_pass		= "WorkLoad100";		// SMTP Password
